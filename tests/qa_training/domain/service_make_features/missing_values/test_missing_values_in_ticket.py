...
def fixture_run():
    ...
    df_customer_info = pd.read_csv("tests/qa_training/domain/service_make_features/missing_values/df_customer_info_in_ticket.csv")
    df_filled_expected = pd.read_csv("tests/qa_training/domain/service_make_features/missing_values/df_filled_expected_in_ticket.csv")
